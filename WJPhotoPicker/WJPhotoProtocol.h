...
// Notifications
#define WJPHOTO_LOADING_DID_END_NOTIFICATION @"WJPHOTO_LOADING_DID_END_NOTIFICATION"
#define WJPHOTO_LOADING_PROGRESS_NOTIFICATION @"WJPHOTO_LOADING_PROGRESS_NOTIFICATION"
...
// Otherwise you can use the WJPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the WJPhoto class for an example implementation of this protocol
//

@protocol WJPhoto <NSObject>
